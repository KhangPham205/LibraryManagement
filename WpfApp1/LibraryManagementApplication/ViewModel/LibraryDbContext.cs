...
namespace LibraryManagementApplication.ViewModel
{
    public class LibraryDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\C:\Users\PC\Documents\GitHub\LibraryManagement\WpfApp1\LibraryManagementApplication\Model\Database\DatabaseLibrary.mdf;Integrated Security=True;MultipleActiveResultSets=True");
        }
